...
module.exports = class extends BaseGenerator {
    ...
    initializing() {
        this.log(chalk.bold('Concourse configuration is starting'));
        this.mainDir = constants.MAIN_DIR;
    }
    ...
    get configuring() {
        return {
            insight() {
                statistics.sendSubGenEvent('generator', 'concourse');
            },

            copyCloudFoundryFiles() {
                if (this.abort) return;
                this.log(chalk.bold('\nCreating Concourse deployment files'));
